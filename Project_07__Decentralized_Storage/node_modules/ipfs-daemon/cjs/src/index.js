...
var prometheusGcStats = require('prometheus-gc-stats');
...
var prometheusGcStats__default = /*#__PURE__*/_interopDefaultLegacy(prometheusGcStats);
...
class Daemon {
  constructor(options = {}) {
    ...
    if (process.env.IPFS_MONITORING) {
      const collectDefaultMetrics = prometheusClient__default["default"].collectDefaultMetrics;
      collectDefaultMetrics({ timeout: 5000 });
      prometheusGcStats__default["default"](prometheusClient__default["default"].register)();
    }
